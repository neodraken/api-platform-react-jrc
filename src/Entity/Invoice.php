 ...
 *     "order":{"sentAt": "desc"}
 *     },
 *     normalizationContext={"groups"={"jojo_invoices_read"}},
...
class Invoice
{
     ...
     * @Groups({"jojo_invoices_read", "jojo_customers_read", "invoices_subresource"})
     */
    private $id;
     ...
     * @Groups({"jojo_invoices_read", "invoices_subresource"})
     * @return User
     */
